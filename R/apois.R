...
#'
#' @return An integer vector of length m with values greater than or equal to 0,
#'   following a Poisson(lambda) distribution.
#'
#' @references
#' Romero, T. (2019).
...
#' Available at:
#' https://tereom.github.io/est-computacional-2019/simulacion-de-variables-aleatorias.html
#'
#' @examples
